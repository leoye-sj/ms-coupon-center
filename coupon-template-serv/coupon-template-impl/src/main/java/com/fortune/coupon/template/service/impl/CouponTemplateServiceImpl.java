package com.fortune.coupon.template.service.impl;
...
import com.fortune.coupon.template.api.beans.TemplateSearchParams;
import com.fortune.coupon.template.api.enums.CouponType;
import com.fortune.coupon.template.converter.CouponTemplateConverter;
import com.fortune.coupon.template.dao.CouponTemplateDao;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public PagedCouponTemplateInfo search(TemplateSearchParams request) {
        ...
        PagedCouponTemplateInfo response = PagedCouponTemplateInfo.builder()
                .templateInfoList(couponTemplateInfos)
